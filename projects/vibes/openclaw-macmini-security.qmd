...
Plugin and startup your Mac Mini and start following the setup.  Youre going to use the first gmail account for the admin users to do the initial setup of the device.
